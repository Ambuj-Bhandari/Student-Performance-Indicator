...
class DataTransformation:
    ...
    def get_data_transformer_obj(self):
        ...
        try:
            ...
            logging.info(f"Numerical columns: {numerical_cols} Scaling completed")
            ...
            logging.info(f"Categorical columns: {categorical_cols} encoding completed")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            save_object(file_path = self.transformation_config.preprocessor_obj_file_path, obj = preprocessor)
